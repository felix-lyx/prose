...
def init_multi(xc, numbers=4, k_tot=4, init_key=2023, num_choise_k=2, if_norm=False,norm_const = 1):
    """
    :param xc: cell center coordinate
    :param mode: initial condition
    :return: 1D scalar function u at cell center
    ...
    slope = (_u[:,-1] - _u[:,0])/(xc[-1]-xc[0])

    _u = _u - jnp.outer(slope,xc)
    carry = if_norm, _u
